...
<head>
<meta charset="UTF-8">
<title>개인 회원정보 검색(cust_retrieval_db.jsp) p400</title>
...
<body>
	...
	<%@ include file="./../../WEB-INF/common/include/jsp_id_check_irud.inc"%>
	...
	<%@ include file="../../WEB-INF/common/include/jsp_sql_dbget_rud.inc"%>
	...
	<table>
		...
		<%@ include file="./../../WEB-INF/common/include/html_output_rd.inc" %>
		
		<tr>
			<td colspan="2" style="text-align:center;">
				<a href="./customer_maintenance.jsp">[고객 정보 관리]</a></td>
		</tr>
	</table>
	</form>
	...
	<%
			 	...
			 	out.println("SQL 질의 처리 오류!" + sqlerr.getMessage());
			} finally {
				//데이터 베이스 연결 종료(close database)
				DbConnClose.resourceClose(rest, stmt, conn);
			}
